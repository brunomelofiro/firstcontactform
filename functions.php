...
ob_start();
 ...
 <div class="postmail"><img src="/wordpress/wp-content/themes/astrid/images/Post-Mail_2-512.png" /></div>
<h2>Don't be shy!</h2></br>
<form action="" method="post">
Firt Name: * <span><?php echo $fnameErr;?></span></br>
<input type="text" class="contact-field" name="fname"  placeholder="First name" />
</br>
Last Name: * <span><?php echo $lnameErr;?></span></br>
<input type="text" class="contact field" name="lname" placeholder="Last Name" />
</br>
E-mail address: *<span><?php echo $emailErr;?></span>
</br>
<input type="text" class="contact-field" name="email"  placeholder="E-mail" />
</br>
State:
</br>
<select class="contact-field" name="state">
<option disable selected>Pick a State</option>
...
<input type="radio" name="true" value="Y" /> Yes <input type="radio" name="true" value="N" /> No
</br></br>
Message: * <span><?php echo $msgErr;?></span>
<textarea name="msg" cols="50" rows="4" placeholder="Write your message here..."></textarea>
</br></br>
...
add_shortcode( 'contactform', 'contact_func');
